...
class ReproduceResetRaceCondition:
    ...
    get_image(self)
        Gets an image from the current camera view of the drone.
    """
    ...
    def get_image(self) -> airsimdroneracinglab.ImageResponse:
        """
        Gets an image from the current camera view of the drone.

        Returns
        -------
            image : airsindroneracinglab.ImageResponse
                Current camera view of the drone
        """
        image = self.airsim_client.simGetImage("fpv_cam", airsimdroneracinglab.ImageType.Scene)
        print(image)
        return image
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for next_gate in range(NUM_GATES):
            ...
            # Writes the current image view to a file
            img: airsimdroneracinglab.ImageResponse = reproducer.get_image()
            file_path: str = f"./gate_images/gate{next_gate}.jpg"
